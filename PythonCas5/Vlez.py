...
#
# vnesibroj = int(input("Vnesete cel broj:"))
# print(vnesibroj+10)
#
# vnesibroj = float(input("Vnesete cel broj:"))
# print(vnesibroj+10)

# grad = "Glavniot grad na Republika Makedonija e Skopje"
# print(grad)
# print(grad[40])
# print(grad[40:47])
#
# print("Vnesete gi stranite na triagolnikot")
#
# stranaA = int(input("Vnesi ja stranata A"))
#
# stranaB = int(input("Vnesi ja stranata B"))
#
# stranaC = int(input("Vnesi ja stranata C"))
#
